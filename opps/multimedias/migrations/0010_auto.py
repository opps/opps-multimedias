...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_posts on 'Video'
        m2m_table_name = db.shorten_name(u'multimedias_video_related_posts')
        ...
        db.create_unique(m2m_table_name, ['video_id', 'container_id'])

        # Adding M2M table for field related_posts on 'Audio'
        m2m_table_name = db.shorten_name(u'multimedias_audio_related_posts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('audio', models.ForeignKey(orm[u'multimedias.audio'], null=False)),
            ('container', models.ForeignKey(orm[u'containers.container'], null=False))
        ))
        db.create_unique(m2m_table_name, ['audio_id', 'container_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_posts on 'Video'
        db.delete_table(db.shorten_name(u'multimedias_video_related_posts'))

        # Removing M2M table for field related_posts on 'Audio'
        db.delete_table(db.shorten_name(u'multimedias_audio_related_posts'))
