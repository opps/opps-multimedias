...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.ffmpeg_file_thumb'
        db.add_column(u'multimedias_video', 'ffmpeg_file_thumb',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Audio.ffmpeg_file_thumb'
        db.add_column(u'multimedias_audio', 'ffmpeg_file_thumb',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.ffmpeg_file_thumb'
        db.delete_column(u'multimedias_video', 'ffmpeg_file_thumb')

        # Deleting field 'Audio.ffmpeg_file_thumb'
        db.delete_column(u'multimedias_audio', 'ffmpeg_file_thumb')
    ...
    models = {
        ...
        u'multimedias.audio': {
            ...
            u'container_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['containers.Container']", 'unique': 'True', 'primary_key': 'True'}),
            'ffmpeg_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
