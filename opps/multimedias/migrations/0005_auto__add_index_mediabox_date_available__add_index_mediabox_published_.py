...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MediaBox', fields ['date_available']
        db.create_index(u'multimedias_mediabox', ['date_available'])

        # Adding index on 'MediaBox', fields ['published']
        db.create_index(u'multimedias_mediabox', ['published'])


        # Changing field 'MediaHost.status_message'
        db.alter_column(u'multimedias_mediahost', 'status_message', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
        # Adding index on 'MediaConfig', fields ['date_available']
        db.create_index(u'multimedias_mediaconfig', ['date_available'])

        # Adding index on 'MediaConfig', fields ['published']
        db.create_index(u'multimedias_mediaconfig', ['published'])


    def backwards(self, orm):
        # Removing index on 'MediaConfig', fields ['published']
        db.delete_index(u'multimedias_mediaconfig', ['published'])

        # Removing index on 'MediaConfig', fields ['date_available']
        db.delete_index(u'multimedias_mediaconfig', ['date_available'])

        # Removing index on 'MediaBox', fields ['published']
        db.delete_index(u'multimedias_mediabox', ['published'])

        # Removing index on 'MediaBox', fields ['date_available']
        db.delete_index(u'multimedias_mediabox', ['date_available'])


        # Changing field 'MediaHost.status_message'
        db.alter_column(u'multimedias_mediahost', 'status_message', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
