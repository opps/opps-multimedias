...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaHost.retries'
        db.add_column(u'multimedias_mediahost', 'retries',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaHost.retries'
        db.delete_column(u'multimedias_mediahost', 'retries')
