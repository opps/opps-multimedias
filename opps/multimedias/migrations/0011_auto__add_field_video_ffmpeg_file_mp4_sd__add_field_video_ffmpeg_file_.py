...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.ffmpeg_file_mp4_sd'
        db.add_column(u'multimedias_video', 'ffmpeg_file_mp4_sd',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.ffmpeg_file_mp4_hd'
        db.add_column(u'multimedias_video', 'ffmpeg_file_mp4_hd',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Audio.ffmpeg_file_mp4_sd'
        db.add_column(u'multimedias_audio', 'ffmpeg_file_mp4_sd',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Audio.ffmpeg_file_mp4_hd'
        db.add_column(u'multimedias_audio', 'ffmpeg_file_mp4_hd',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.ffmpeg_file_mp4_sd'
        db.delete_column(u'multimedias_video', 'ffmpeg_file_mp4_sd')

        # Deleting field 'Video.ffmpeg_file_mp4_hd'
        db.delete_column(u'multimedias_video', 'ffmpeg_file_mp4_hd')

        # Deleting field 'Audio.ffmpeg_file_mp4_sd'
        db.delete_column(u'multimedias_audio', 'ffmpeg_file_mp4_sd')

        # Deleting field 'Audio.ffmpeg_file_mp4_hd'
        db.delete_column(u'multimedias_audio', 'ffmpeg_file_mp4_hd')
    ...
    models = {
        u'accounts.customuser': {
            ...
            'city': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['localidades.City']", 'null': 'True', 'blank': 'True'}),
            ...
            'ddd_home_phone': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'ddd_mobile_phone': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            ...
            'field_permissions': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'field_permissions_set'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.Group']"}),
            ...
            'last_billet': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'newsletter': ('django.db.models.fields.CharField', [], {'default': "'e'", 'max_length': '2'}),
            'number': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'previous_type': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '3', 'db_index': 'True'}),
            'previous_type_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'rg': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['localidades.State']", 'null': 'True', 'blank': 'True'}),
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '3', 'db_index': 'True'}),
            'type_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        u'multimedias.audio': {
            ...
            'related_posts': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'audio_relatedposts'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['containers.Container']"}),
            'short_title': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
