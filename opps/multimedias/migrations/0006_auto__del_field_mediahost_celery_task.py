...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaHost.celery_task'
        db.delete_column(u'multimedias_mediahost', 'celery_task_id')


    def backwards(self, orm):
        # Adding field 'MediaHost.celery_task'
        db.add_column(u'multimedias_mediahost', 'celery_task',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djcelery.TaskMeta'], unique=True, null=True),
                      keep_default=False)
