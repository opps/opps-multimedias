...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.local'
        db.add_column(u'multimedias_video', 'local',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name=u'local_video', unique=True, null=True, to=orm['multimedias.MediaHost']),
                      keep_default=False)

        # Adding field 'Audio.local'
        db.add_column(u'multimedias_audio', 'local',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name=u'local_audio', unique=True, null=True, to=orm['multimedias.MediaHost']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.local'
        db.delete_column(u'multimedias_video', 'local_id')

        # Deleting field 'Audio.local'
        db.delete_column(u'multimedias_audio', 'local_id')
