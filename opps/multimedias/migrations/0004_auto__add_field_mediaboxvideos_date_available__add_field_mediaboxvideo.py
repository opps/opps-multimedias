...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaBoxVideos.date_available'
        db.add_column(u'multimedias_mediaboxvideos', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)

        # Adding field 'MediaBoxVideos.date_end'
        db.add_column(u'multimedias_mediaboxvideos', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MediaBoxAudios.date_available'
        db.add_column(u'multimedias_mediaboxaudios', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)

        # Adding field 'MediaBoxAudios.date_end'
        db.add_column(u'multimedias_mediaboxaudios', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaBoxVideos.date_available'
        db.delete_column(u'multimedias_mediaboxvideos', 'date_available')

        # Deleting field 'MediaBoxVideos.date_end'
        db.delete_column(u'multimedias_mediaboxvideos', 'date_end')

        # Deleting field 'MediaBoxAudios.date_available'
        db.delete_column(u'multimedias_mediaboxaudios', 'date_available')

        # Deleting field 'MediaBoxAudios.date_end'
        db.delete_column(u'multimedias_mediaboxaudios', 'date_end')
